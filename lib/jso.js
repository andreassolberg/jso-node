...
var OAuth = Class.extend({
	...
	"checkToken": function(callback, redirectCallback, opts) {
	...
	"getToken": function(callback, redirectCallback, opts) {
		// var scopesRequest  = this._getRequestScopes(opts);
		var scopesRequire = this._getRequiredScopes(opts);
	...
	"_authorize": function(callback, redirectCallback, opts) {
		var 
			request,
			authurl,
			scopes;
	...
	"getJSON":  function(url, options, callback, redirectCallback) {
